...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=+6288222015293&text=Assalamualaikum coba SC nya kakak ganteng 😘')
...
def restart():
    ...
    Print 'slamat datang ngab'
    print 'Anda Telah Login'
    print 'jngan ngocok mulu'
    sys.exit
else:
